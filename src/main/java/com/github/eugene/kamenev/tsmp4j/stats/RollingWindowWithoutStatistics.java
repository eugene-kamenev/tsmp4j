...
public class RollingWindowWithoutStatistics implements RollingWindowStatistics<NoStatistic> {
    ...
    @Override
    public ObjBuffer<NoStatistic> getStatsBuffer() {
    ...
    @Override
    public NoStatistic apply(double value) {
        this.totalDataCount++;
