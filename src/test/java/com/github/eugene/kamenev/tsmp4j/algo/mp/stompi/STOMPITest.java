...
class STOMPITest extends BaseTest {

    private static final double ERROR = Math.pow(10, -10);

    @Test
    void testIncrementalStompi() {
        var windowSize = 30;
        BaseRollingWindowStatistics<BaseWindowStatistic> initialStats =
            new BaseRollingWindowStatistics<>(windowSize, 200);
